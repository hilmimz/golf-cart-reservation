                    ...
                    <div class="row col-10">
                        ...
                        <div class="col-xl col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="row">
                                <h4 class="col-6 d-flex justify-content-start">{{ $route_start->name }}
                                        ...
                                        <div class="row d-flex justify-content-center mt-4 mb-4">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="text-xs font-weight-bold text-uppercase mb-1">Golf Cart</label>
                                            ...
                                            <!-- Switch Button -->
                                            <div class="col-md-0 mt-4 mx-2">
                                            <button onclick="switchHalte()" type="submit" class="btn btn-primary">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="container-fluid custom-container">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-2 custom-content">
                                            <h6>{{ \Carbon\Carbon::parse($result['end_time'])->format('H:i') }}</h6>
                                            <p>{{ $route_end->name }}</p>
                                        </div>

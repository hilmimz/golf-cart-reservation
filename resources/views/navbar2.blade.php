    ...
    <div id="mySidenav" class="sidenav">
        ...
        <a href="{{ url('/dashboard_admin') }}" style="margin-top: 100%"><i class="fa fa-home"></i><p>Home</p></a>
        <a href="{{ url('/dashboard_admin/rute') }}"><i class="fa fa-road"></i><p>Kelola Rute</p></a>
        <a href="{{ url('/dashboard_admin/jadwal') }}"><i class="fa fa-calendar"></i><p>Kelola Jadwal</p></a>
